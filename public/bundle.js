...
/***/ function(module, exports, __webpack_require__) {
	...
	var Room = __webpack_require__(249);
	...
	module.exports = React.createElement(
	  Route,
	  { path: '/', component: Main },
	  React.createElement(Route, { path: 'room/:roomname', component: Room }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _helpers2.default.getIptvInfo(this.props.params.room).then(function (data) {
	      this.setState({
	        rooms: data.rooms
	      });
	    }.bind(this));
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'text-center' },
	        _react2.default.createElement(Table, { rooms: this.state.rooms })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getRooms() {
	  return _axios2.default.get('http://localhost:3009/api/reception/v1/rooms.json');
	}

	function getReservations(username) {
	  return _axios2.default.get('http://localhost:3009/api/reception/v1/reservations');
	}

	var helpers = {
	  getIptvInfo: function getIptvInfo() {
	    return _axios2.default.all([getRooms(), getReservations()]).then(function (arr) {
	      return {
	        rooms: arr[0].data,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(240);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var TableRow = __webpack_require__(248);
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            this.props.rooms.map(function (room, i) {
	              return React.createElement(TableRow, { key: i, data: room });
	            })
	          )
	        )
	      )
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'td',
	        null,
	        this.props.data.check_in_date
	      ),
	      React.createElement(
	        'td',
	        null,
	        this.props.data.check_out_date
	      ),
	      React.createElement(
	        'td',
	        null,
	        this.props.data.room_guests
	      ),
	      React.createElement(
	        'td',
	        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoomReservations = __webpack_require__(250);

	var _RoomReservations2 = _interopRequireDefault(_RoomReservations);

	var _RoomDetaills = __webpack_require__(251);

	var _RoomDetaills2 = _interopRequireDefault(_RoomDetaills);

	var _RoomMessages = __webpack_require__(252);
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'col-md-6' },
	        _react2.default.createElement(_RoomDetaills2.default, {
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'col-md-4' },
	        _react2.default.createElement(_RoomReservations2.default, {
	...
	var RoomDetails = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var details = this.props.rooms.map(function (room, index) {
	      if (room.room_name === roomName) return React.createElement(
	        'div',
	        { key: index },
	        React.createElement(
	          'table',
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'td',
	                null,
	                room.room_name === roomName && React.createElement(
	                  'h4',
	                  null,
	                  room.room_name,
	                  ' '
